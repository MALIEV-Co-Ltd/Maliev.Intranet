...
This repository follows MALIEV's editorial social direction: white space, black ink, disciplined typography, and product-visible operational interfaces. The system is intentionally not Vercel, Apple, or any external brand reference.
...
Intranet UI should look like a working operations system: practical, quiet, high contrast, and typographically precise. If a component starts to look like a blue SaaS modal, a gradient landing page, or a borrowed design-system demo, bring it back to white, `#333333`, and clear operational workflow.
