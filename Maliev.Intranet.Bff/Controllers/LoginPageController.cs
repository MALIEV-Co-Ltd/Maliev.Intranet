...
<head>
    ...
    <script src="/js/google-identity-signin.js" defer></script>
    ...
    <div class="login-shell">
        ...
        <main class="login-main">
            <section class="login-gateway-card" aria-labelledby="login-title">
                ...
                {{errorHtml}}
                <div class="google-signin-host"
                     data-google-signin-host
                     data-return-url="{{encodedReturnUrl}}"
                     aria-label="Continue with Google"></div>
                <p class="google-signin-status" data-google-signin-status role="status" aria-live="polite" hidden></p>
