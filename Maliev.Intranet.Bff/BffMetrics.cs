...
public class BffMetrics
{
    ...
    public BffMetrics(IMeterFactory meterFactory)
    {
        ...
        _browserDfmRuntimeInputBytes = meter.CreateHistogram<long>(
            "intranet_browser_dfm_runtime_input_bytes",
            unit: "By",
            description: "Records browser-first local DFM runtime input payload sizes observed by Intranet.");
        _browserDfmRuntimeInputTriangles = meter.CreateHistogram<long>(
            "intranet_browser_dfm_runtime_input_triangles",
            unit: "{triangle}",
            description: "Records browser-first local DFM runtime triangle workloads observed by Intranet.");
        ...
        _dfmServerAvoidedInputBytes = meter.CreateHistogram<long>(
            "intranet_dfm_server_avoided_input_bytes",
            unit: "By",
        ...
        _dfmServerAvoidedInputTriangles = meter.CreateHistogram<long>(
            "intranet_dfm_server_avoided_input_triangles",
            unit: "{triangle}",
