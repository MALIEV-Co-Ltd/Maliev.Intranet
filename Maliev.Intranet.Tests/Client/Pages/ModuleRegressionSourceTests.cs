...
public class ModuleRegressionSourceTests
{
    ...
    public void TopBar_TabletAndMobileLayoutKeepsNavSearchAndProfileInBounds()
    {
        ...
        Assert.Contains("min-height: 48px;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-link"), StringComparison.Ordinal);
        Assert.Contains("padding: 10px 14px;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-link"), StringComparison.Ordinal);
        Assert.Contains("grid-template-columns: 28px minmax(0, 1fr);", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-group-title"), StringComparison.Ordinal);
        Assert.Contains("min-height: 40px;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-group-title"), StringComparison.Ordinal);
        Assert.Contains("padding: 8px 14px 6px;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-group-title"), StringComparison.Ordinal);
        Assert.Contains("width: 28px;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-link .mud-icon-root"), StringComparison.Ordinal);
