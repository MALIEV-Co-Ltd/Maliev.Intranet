...
public class ModuleRegressionSourceTests
{
    ...
    public void TopBar_TabletAndMobileLayoutKeepsNavSearchAndProfileInBounds()
    {
        ...
        Assert.Contains("grid-template-columns: 24px minmax(0, 1fr);", mobileNavLinkBlock, StringComparison.Ordinal);
        ...
        Assert.Contains("grid-template-columns: 24px minmax(0, 1fr);", mobileGroupTitleBlock, StringComparison.Ordinal);
        ...
        Assert.Contains("width: 22px;", mobileNavLinkIconBlock, StringComparison.Ordinal);
        Assert.Contains("justify-self: center;", mobileNavLinkIconBlock, StringComparison.Ordinal);
        Assert.Contains("flex: 0 0 22px;", mobileNavLinkIconBlock, StringComparison.Ordinal);
        Assert.Contains(".topbar-mobile-nav-link > span", compactNavStyles, StringComparison.Ordinal);
        Assert.Contains("overflow: hidden;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-link > span"), StringComparison.Ordinal);
        Assert.Contains("text-overflow: ellipsis;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-link > span"), StringComparison.Ordinal);
        Assert.Contains("white-space: nowrap;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-link > span"), StringComparison.Ordinal);
        ...
        Assert.Contains("justify-self: center;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-group-title ::deep .mud-icon-root"), StringComparison.Ordinal);
