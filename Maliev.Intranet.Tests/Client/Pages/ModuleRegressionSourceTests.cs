...
public class ModuleRegressionSourceTests
{
    ...
    public void TopBar_TabletAndMobileLayoutKeepsNavSearchAndProfileInBounds()
    {
        ...
        Assert.Contains("padding: 10px 12px;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-link"), StringComparison.Ordinal);
        ...
        Assert.Contains("width: 24px;", ExtractCssBlock(compactNavStyles, ".topbar-mobile-nav-link ::deep .mud-icon-root"), StringComparison.Ordinal);
